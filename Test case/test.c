...
int main(){
    ...
    // FILE *fptr;
    // if((fptr = fopen("tpltm.txt", "r")) == NULL){
...
//     /*------------------------Doc FILE-----------------------*/
//     FILE* fptr = fopen("fatherCode.txt", "r");
//     if(fptr == NULL) {
//         printf("Cannot open input.txt!\n");
//     }
//     fscanf(fptr, "%d", &num_e);
...
//PRUFER CODE
    ...
    // int *deg, n, m;
    // FILE *fptr;
    // if((fptr=fopen("tomau.txt", "r"))==NULL){
    ...
    //DIJKSTRA
    FILE *fptr;
    if((fptr = fopen("dijkstra.txt", "r")) == NULL){
        printf("Khong mo duoc file\n");
        return -1;
    }
    int n, u;
